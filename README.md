...
A game where you play as a lab TA and you need to slime students that caught cheating on a lab quizz


#Controls

Buttons will move the square 16 pixels in the direction.
Press left and right button at the same time to reset the map and square position
